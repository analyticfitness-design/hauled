      ...
      <section class="enc-hero">
        ...
        <div class="container enc-hero-inner">
          ...
          <div class="enc-hero-cta-wrap">
            ...
            <button type="button" class="enc-cta-primary" @click="openChat('encargo_inquiry')">
...
const { link, openChat, adminNumber: waNumber } = useWhatsApp();
const waLink = link('encargo_inquiry');
